...
import { Layers, Download, RotateCcw, X, Loader2, KeyRound, CheckCircle2, AlertCircle } from "lucide-react";
    ...
    <div className="space-y-4">
      ...
      {images.length > 0 && (
        <div className="grid grid-cols-4 sm:grid-cols-5 gap-2">
          {images.map((item) => (
            <div key={item.id} className="relative group rounded-lg overflow-hidden border border-border bg-secondary/50 aspect-square">
